...
public class UpdateRobotLabelTest {
    ...
    void shouldAddLabelToRobot() {
        ...
        UpdateRobotLabel commandLabel0 = new UpdateRobotLabel("label0_", environment, RobotCommand.SIGNAL);
        commandLabel0.run(robot, 1);
        assertEquals(robot.getCurrentConditionLabels().size(), 1);
        UpdateRobotLabel commandLabel1 = new UpdateRobotLabel("label1_", environment, RobotCommand.SIGNAL);
